            ...
            {loading ? (
                ...
                <>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <StatCard title="Total Classes" value={stats.totalClasses} icon="🏫" color="bg-green-500" />
                        <StatCard title="Total Subjects" value={stats.totalSubjects} icon="📚" color="bg-yellow-500" />
                        <StatCard title="Attendance Rate" value={`${stats.attendanceRate}%`} icon="📋" color="bg-purple-500" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div className="bg-white rounded-lg shadow p-6">
                            ...
                            <div className="border-t pt-4">
                                <p className="text-gray-500">No upcoming classes to display</p>
                            </div>
                        </div>
